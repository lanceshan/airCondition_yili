...
LDD_TDeviceData* BitsIoLdd1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOB_PDDR: PDD&=~0x00F00000 */
  GPIOB_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x00F00000));
  /* GPIOB_PIDR: PID&=~0x00F00000 */
  GPIOB_PIDR &= (uint32_t)~(uint32_t)(GPIO_PIDR_PID(0x00F00000));
